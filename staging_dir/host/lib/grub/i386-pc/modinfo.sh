...
grub_target_cc_version='x86_64-openwrt-linux-uclibc-gcc (OpenWrt/Linaro GCC 4.8-2014.04 r47269) 4.8.3'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /home/buildbot/slave-local/x86_64/build/staging_dir/toolchain-x86_64_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/x86_64-openwrt-linux-uclibc/4.8.3/include'
